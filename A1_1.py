...
class Page2(Page):
    ...
    def plotear():
        ...
        #if n>1:
        #    ax1.plot(pow(10,9)*wavelength+n*pow(10,10), 10*np.log10(potencia)+30)
            
        #if Unidades=='mW':
        #    ax1.plot(wavelength, 1000*(potencia))
    ...
    def Ajustar():
        ...
        if Seguimiento=='Seguir: Sí':
            lambda_central=Ajustes[contador-1]
